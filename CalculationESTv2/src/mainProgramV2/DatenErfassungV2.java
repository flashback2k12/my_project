...
public class DatenErfassungV2 {
	...
	private JTextField txt_wkPr�fung;
	...
	private void initialize() {
		...
		btnBerechneWerbungsKosten.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				txt_wkPr�fung.setText("" + '\t' + werbungsKosten); 
		...
		btnBerechneEST.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				/*
				 * Berechnung Summe / Gesamtbetrag Eink�nfte
				 */
				...
				/**
				 * ACHTUNG ERFORDERLICHE CODE OPTIMIERUNG --> ALLEINERZIEHENDEN BETRAG; ALTERSBETRAG; L+F FB BER�CKSICHTIGEN
				 */
				 ...
				 * 
				 * 0.74 ist nur f�r 2012 --> Vergleichabfrage schreiben f�r den Zeitraum von 2010 - 2015 --> fixed
				 */
				 ...
				 */
				/**
				 * ACHTUNG ERFORDERLICHE CODE OPTIMIERUNG --> ABGLEICH H�CHSTBETR�GE --> fixed
				 */
		...
		btnCreateTextFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 */
				/**
				 * ACHTUNG ERFORDERLICHE CODE OPTIMIERUNG --> ENTFERNUNG Pr�fungs - TEXTFIELDS OHNE BEDEUTSAMEN NUTZEN
				 */
				...
				String AGB = "\n ./. aussergew�hnliche Belastungen: "+ '\t' + '\t' + txt_agb.getText(); 
		...
		txt_wkPr�fung = new JTextField();
		txt_wkPr�fung.setBounds(765, 560, 144, 20);
		frame.getContentPane().add(txt_wkPr�fung);
		txt_wkPr�fung.setColumns(10);
